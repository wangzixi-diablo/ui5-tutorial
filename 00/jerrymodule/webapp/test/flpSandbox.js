		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World",
									"targetURL": "#comjerryjerrymodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comjerryjerrymodule-display": {
								"semanticObject": "comjerryjerrymodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.jerry.jerrymodule",
									"url": sap.ui.require.toUrl("com/jerry/jerrymodule")
								}
							}
						}
					}
