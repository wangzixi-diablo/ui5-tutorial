sap.ui.define([
	...
	return Controller.extend("sap.ui5.walkthrough.controller.App", {
		...
		onSelect: function(){
			...
			if( this.bAgeButtonClicked === true ){
				this.bAgeButtonClicked = false;
			...
			for( var i = 0; i < items.length; i++){
				var oItem = items[i];
				var age = parseInt(oItem.getCells()[3].getValue());
				if( age >= 25){
					oTable.setSelectedItem(oItem);
				}
			}
			this.bAgeButtonClicked = true;
		},
