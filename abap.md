...
## 本专栏计划的文章数在 `300` 篇左右，到 `2024 年 3 月 10 日`为止，目前已经更新了 `165` 篇，专栏完成度为 `52.6%`
...
* [143. SAP S/4HANA 系统的底层基石 - 通过实际的例子，介绍 CDS View 入门级的概念](https://blog.csdn.net/i042416/article/details/136598724)
