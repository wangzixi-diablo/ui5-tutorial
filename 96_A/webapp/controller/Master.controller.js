sap.ui.define([
	...
	return Controller.extend("sap.ui5.walkthrough.controller.Master", {
		...
		onInit: function () {
			...
			sap.ui.getCore().getEventBus().subscribe("DataLoaded", this.handleDataLoaded, this);
		},

		handleDataLoaded: function(channel, eventId, oLoadedData){
			this.oPageButtonControl.totalPageNumber = oLoadedData.totalNumber;
			this.oPageButtonControlModel.refresh();
		},
